...
1. You negotiate ADR contract clauses
2. You participate in ADR processes
3. You act as a third party in resolving work disputes

1/3 的律師不曾建議他們的客戶使用調解或仲裁。其中一個原因是利益，訴訟能賺更多錢。

## 🔷 Dispute Prevention

*Preventive Law: The first principle of preventive law is that it is often more important to predict what people will do than to predict what a court will do... Winning a lawsuit can be ruinous.*

- 預防性法則關注的不是打贏官司，而是人們為什麼要上法院

> "I was ruined twice in my life: once when I lost a lawsuit and once when I won one."
— 伏爾泰

- 萬豪酒店（Marriott）
    - 教授希望櫃檯打電話叫他起床，但當天電話沒有響
    - 教授有設鬧鐘，所以沒有遲到
    - 在填寫意見表的時候，教授提到了這件事
    - 兩週後，教授收到萬豪酒店董事長（J Willard Marriott）的來信。
    「發生這樣的事情讓我很失望，請接受我真誠的道歉。我已經向該酒店反應此問題，要求他們改善。感謝您抽空寫下您的寶貴意見，希望我們有幸再次為您服務，已重獲您的信任。」

- Connie Francis & 豪生酒店
    - 遭人闖入並發生悲劇
    - Connie 並未收到豪生酒店的任何道歉，非常生氣
    - 豪生酒店知情後，詢問律師，律師認為上法院自己不會敗訴，現在最好不要和他談話
    - Connie 提告，這件事情讓豪生酒店的形象變得非常負面，最後還是寫了一張250萬的支票
...
1. Mediation — e.g., Mini-trial
    ...
    - 他們得以想出一個從商業的角度來看明智的方案
    - Telecredit & TRW 的 mini-trial
        - 雙方因智慧財產權有爭議，且訴訟多年無果，決定自己用商業的方式來解決
        - 有五個人，雙方代表與他們的律師，加上一位中立的智慧產權專家
        - 一方的律師先陳述案件，有問題向專家提問。接著換另一方的律師陳述，向專家提問
        - 雙方代表獨自走進一個房間，半小時後達成協議
2. Arbitration — e.g., Rent-A-Judge
    - 比較快，一般來說訴訟可能都要好幾年才會落幕
    - 比較便宜，對雙方來說
    - 這件事情不會公開（仲裁可以說是私密的訴訟）
    - 可以選擇法官，若走普通的法庭系統我們可能會碰到不熟悉領域的法官
    - 布萊德彼特與珍妮佛的爭議 Rent-A-Judge
        - 租一個退休法官，來幫助達成協議
    - 棒球球員薪水
        - 雙方對薪水有爭議，請了仲裁員來協助
        - 在棒球項目上，他們採用一種獨特的仲裁形式
        - 與其直接讓仲裁員選擇薪水，他們會讓雙方在私下給仲裁員一個數字，而仲裁員必須從兩個裡面挑選一個
        - 這迫使雙方會選擇一個更中間的數字，否則仲裁員會選擇另一個人的數字

            *👆 比如說A要＄22，B要＄13，若私下A給＄20，B給＄13，則仲裁員會選擇＄20的*
...
- 公司承諾是一種可以採納為公司政策的承諾
- 其中一個好處是能幫助人們避開心理陷阱 — Reactive devaluation
（我：「公司已採用這個承諾多年，您可以考慮也採納看看。」）
...
- 篩選標準就是一個問題清單，它是為除了律師以外的商界人士設計的，基於回答的答案，去選擇要用有法律效力的還是沒有法律效力的ADR程序（binding: litigation, arbitration）
- 利用這個去選擇用什麼方式解決 dispute resolution
...
1. Mediation
2. Arbitration
3. Linked Mediation + Arbitration
4. Linked Negotiation Mediation + Arbitration
...
*其實我們生活中許多買賣都有註明，若發生爭議會使用仲裁來解決（Amazon, eBay, ...）。*
...
3. 休息一下
4. 雙方回來做最後陳述
5. arbitrator 聽完，會經過一段時間 (ex. 30天) 思考再下判決。
...
- Transformative: 轉化雙方的關係，尤其是供較弱勢的一方有發表意見的權利
    - 性騷擾範例
...
2. 如何分辨三種不同的 mediation？
    - 是否是一個用來解決特定問題的調解？是 → evaluative/facilitative，否 → transformative
    - Mediator 是否有被要求要給出一個評估？是 → evaluative，否 → facilitative

        👆 *如果決定要用 evaluative mediation，mediator 是誰就很重要了，他需要有專業知識來評估*

3. 一個好的 mediator 有什麼樣的特質？
    - active listening: 不止聆聽，還會重新 reframe 對方的陳述
    - suggesting options: 提供各種方案給雙方考慮
